...
public class Division_medium extends Activity {
    ...
    private boolean checkAnswer() {
        ...
        if (correct == true) {
            ...
            AlertDialog.Builder Success = new AlertDialog.Builder(Division_medium.this);
    ...
    void updateQuestion(){
        if (mPoints == questions_number) {
            ...
            alert.show();
            Intent intent = new Intent(Division_medium.this, ResultActivity.class);
