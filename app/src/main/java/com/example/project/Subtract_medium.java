...
public class Subtract_medium extends Activity {
    ...
    private boolean checkAnswer() {
        ...
        if (correct == true) {
            ...
            AlertDialog.Builder Success = new AlertDialog.Builder(Subtract_medium.this);
    ...
    void updateQuestion(){
        if (mPoints == questions_number) {
            ...
            alert.show();
            Intent intent = new Intent(Subtract_medium.this, ResultActivity.class);
