...
public class Division_normal extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.division_main);
    ...
    private boolean checkAnswer() {
        ...
        boolean correct = (Math.round(a/b)  == d);
        if (correct == true) {

            AlertDialog.Builder Success = new AlertDialog.Builder(Division_normal.this);
    ...
    void updateQuestion(){
        if (mPoints == questions_number) {
            ...
            alert.show();
            Intent intent = new Intent(Division_normal.this, ResultActivity.class);
