...
public class Division_hard extends Activity {
    ...
    private boolean checkAnswer() {
        ...
        if (correct == true) {
            ...
            AlertDialog.Builder Success = new AlertDialog.Builder(Division_hard.this);
    ...
    void updateQuestion(){
        if (mPoints == questions_number) {
            ...
            alert.show();
            Intent intent = new Intent(Division_hard.this, ResultActivity.class);
    ...
    public ArrayList<Integer> questions_generation(){
        ...
        for (int i = 0; i < 10; i++) {
            values.add(rand.nextInt(500 +1));
        }
        ArrayList<Integer> qwerty = new ArrayList<>();
        int a = values.get(1)+500;
        int b = values.get(2);
        if (b == 0){
            b++;
        }
