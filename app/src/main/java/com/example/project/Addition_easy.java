...
public class Addition_easy extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mScoreTextView.setText("Score:" + mScore + "/" + questions_number);
    ...
    private void checkAnswerTrue() {
        ...
        if (correct == true) {
            ...
            AlertDialog.Builder Success = new AlertDialog.Builder(Addition_easy.this);
            Success.setTitle("Ваш ответ Правильный ");
            Success.show();
            mScore++;
            mPoints++;
        } else {
            AlertDialog.Builder Failure = new AlertDialog.Builder(Addition_easy.this);
    ...
    void updateQuestion(){
        if (mPoints == questions_number) {
            ...
            alert.show();
            Intent intent = new Intent(Addition_easy.this, ResultActivity.class);
