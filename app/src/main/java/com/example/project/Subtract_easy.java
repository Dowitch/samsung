...
public class Subtract_easy extends Activity {
    ...
    private boolean checkAnswer() {
        ...
        if (correct == true) {
            ...
            AlertDialog.Builder Success = new AlertDialog.Builder(Subtract_easy.this);
    ...
    void updateQuestion(){
        if (mPoints == questions_number) {
            ...
            alert.show();
            Intent intent = new Intent(Subtract_easy.this, ResultActivity.class);
