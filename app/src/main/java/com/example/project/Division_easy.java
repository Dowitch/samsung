...
public class Division_easy extends Activity {
    ...
    private boolean checkAnswer() {
        ...
        if (correct == true) {
            ...
            AlertDialog.Builder Success = new AlertDialog.Builder(Division_easy.this);
    ...
    void updateQuestion(){
        if (mPoints == questions_number) {
            ...
            alert.show();
            Intent intent = new Intent(Division_easy.this, ResultActivity.class);
